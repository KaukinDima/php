<?php
$config['smtp_username'] = 'mail@yandex.kz';  //Смените на адрес своего почтового ящика.
$config['smtp_port'] = '465'; // Порт работы.
$config['smtp_host'] =  'ssl://smtp.yandex.kz';  //сервер для отправки почты
...
$config['smtp_from'] = 'name'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
